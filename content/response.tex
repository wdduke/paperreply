% !TeX encoding = UTF-8
We thank the referee for the careful reading of our manuscript and for the constructive suggestions. The comments helped us clarify the purpose of the proposed calibration method, improve the notation, and make the experimental procedure easier to reproduce.

\begin{revisionsummary}
\item Clarified when field calibration is preferable to standard laboratory recalibration.
\item Defined the drift correction term before presenting the first equation.
\item Expanded the field protocol so that the experiment can be reproduced more easily.
\item Added a limitation about abrupt sensor failure and nonlinear drift.
\end{revisionsummary}

\reviewersection{Reviewer 1}

\begin{replypoint}[Revised]{Motivation and scope}
...
\begin{replypoint}[Revised]{Definition of the correction term}
\begin{refereecomment}
...
\revisionloc{Section 3, first paragraph and Equation 1}
\end{authorreply}
\end{replypoint}

\begin{replypoint}[Revised]{Reproducibility of the field protocol}
\begin{refereecomment}
...
\revisionloc{Section 4, Field protocol}
\end{authorreply}
\end{replypoint}

\begin{replypoint}[Revised]{Limitations}
\begin{refereecomment}
...
\revisionloc{Discussion, Limitations paragraph}
\end{authorreply}
\end{replypoint}

\begin{replypoint}[Revised]{Wording}
\begin{refereecomment}
...
\revisionloc{Results, final paragraph}
\end{authorreply}
\end{replypoint}
